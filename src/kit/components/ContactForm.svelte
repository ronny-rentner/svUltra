<script module>
  // Default stub. The pattern is a singleton modal: `dialog` is a
  // module-level reference that the mounted instance writes via
  // bind:this; the named `onclick` export is what triggers (e.g. Footer)
